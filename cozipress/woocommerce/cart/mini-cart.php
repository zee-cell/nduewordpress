...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	<div class="shopping-cart-header">
			...
			<?php 
				if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
					...
					<?php 
						...
						?>
						<span class="badge"><?php esc_html_e('0','cozipress'); ?></span>
						<?php 
					}
				}
			?>
		...
		<div class="shopping-cart-total">
			<span class="lighter-text"><strong><?php _e( 'Total:', 'cozipress' ); ?></strong></span>
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'cozipress' ),
							esc_attr( $product_id ),
	...
	<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="btn btn-primary btn-like-icon"><?php echo esc_html_e('Checkout','cozipress'); ?> <span class="bticn"><i class="fa fa-shopping-basket"></i>
		<?php 
			if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
				$count = WC()->cart->cart_contents_count;
				$cart_url = wc_get_cart_url();
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'cozipress' ); ?></p>
