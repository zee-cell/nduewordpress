 ...
 */
function cozipress_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function cozipress_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function cozipress_sanitize_html( $html ) {
 ...
 */
function cozipress_sanitize_image( $image, $setting ) {
 ...
 */
function cozipress_sanitize_nohtml( $nohtml ) {
 ...
 */
function cozipress_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function cozipress_sanitize_range_value( $number, $setting ) {
 ...
 */
function cozipress_sanitize_select( $input, $setting ) {
 ...
 */
function cozipress_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function cozipress_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function cozipress_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
